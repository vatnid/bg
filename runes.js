...
function trans2rune(input) {
  var transcription = ["a", "å", "b", "c", "d", "ð", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "ŋ", "o", "p", "q", "q̇", "r", "s", "t", "u", "v", "w", "ʷ", "x", "y", "ʸ", "z", "þ", "́"]
  var runes = ["ᚫ", "ᚪ", "ᛒ", "ᚳ", "ᛞ", "ᚧ", "ᛖ", "ᚠ", "ᚸ", "ᚻ", "ᛁ", "ᚷ", "ᛣ", "ᛚ", "ᛗ", "ᚾ", "ᛝ", "ᚩ", "ᛈ", "ᚢ", "ᚤ", "ᚱ", "ᛋ", "ᛏ", "ᛇ", "ᚥ", "ᚹ", "ᚹ", "ᛋᚳ", "ᛄ", "ᛄ", "ᛉ", "ᚦ", "̇"]
